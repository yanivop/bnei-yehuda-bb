...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 640px) {
    ...
    .conflict-body { grid-template-columns: 1fr; grid-template-areas: "a" "div" "b"; }
    .conflict-divider { display: none; }
    .conflict-game:first-child { border-bottom: 1px solid var(--line); }
  }
</style>
</head>
<body>
  ...
  container.innerHTML = conflicts.map(({ day, a, b, diffMin }) => {
    ...
    const gameHtml = (m) => \`
      <div class="conflict-game">
        <div class="conflict-game-time">\${m.timeLabel}</div>
        ...
        \${m.venue ? \`<div class="conflict-game-venue">📍 \${m.venue.split(',')[0]}</div>\` : ''}
      </div>\`;
