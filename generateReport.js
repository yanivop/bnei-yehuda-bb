...
const TRANSPORT_FORM_OPTIONS = new Set([
  "ילדות א דרום נבא | הפועל כפר סבא - בני יהודה תל אביב",
  "נערות א לאומית עליון | עירוני אעבלין - בני יהודה תל אביב",
  "נערים א מחוזית ת\"א | מכבי תל אביב - בני יהודה תל אביב",
  "נערים ב תל אביב | הפועל תל אביב אביב - בני יהודה תל אביב",
  "ב תל אביב | מכבי רמת גן עתיד - בני יהודה ת״א שושני",
  "קט סל ב רמת השרון | א.ס. רמת השרון כוכבים - בני יהודה תל אביב",
  "ילדים ב תל אביב | מכבי תל אביב מערב - בני יהודה תל אביב",
]);
