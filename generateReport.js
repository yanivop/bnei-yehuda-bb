...
const TRANSPORT_FORM_OPTIONS = new Set([
  "נערים א מחוזית ת\"א | הפועל תל אביב - בני יהודה תל אביב",
  "קט סל א בנות תל אביב | מכבי תל אביב דרום - בני יהודה ת\"א",
  "נערים ב תל אביב | מכבי תל אביב מערב - בני יהודה תל אביב",
  "ילדות א דרום נבא | בני הרצליה - בני יהודה תל אביב",
  "ילדות ב תל אביב | מכבי ת\"א דור העתיד - בני יהודה ת\"א",
  "ילדות א דרום נבא | אליצור חולון - בני יהודה תל אביב",
  "ב תל אביב | הפועל אזור חממי - בני יהודה ת״א שושני",
