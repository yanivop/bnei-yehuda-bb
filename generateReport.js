...
const TRANSPORT_FORM_OPTIONS = new Set([
  "ילדות א דרום נבא | הפועל נס ציונה טל - בני יהודה תל אביב",
  "קט סל א בנות תל אביב | מכבי רמת גן עירוני - בני יהודה ת\"א",
  "נערות א לאומית עליון | מכבי אשדוד/גדרות - בני יהודה תל אביב",
  "נערים א מחוזית ת\"א | מכבי בית דגן - בני יהודה תל אביב",
