...
const TRANSPORT_FORM_OPTIONS = new Set([
  "קט סל א גוש דן | מכבי דרום רמת גן - בני יהודה תל אביב",
  "נערות ב על בית עליון | מכבי תל אביב תמר - בני יהודה תל אביב",
  "נערים ב תל אביב | הפועל ת\"א/אוסישקין - בני יהודה תל אביב",
  "ילדות א דרום נבא | הפועל אשקלון מאיה - בני יהודה תל אביב",
